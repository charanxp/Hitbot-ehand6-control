...
* **`dual_mode_demo.py`**: A dual-mode script that supports both MANUAL key triggers (`a-p`) and AUTONOMOUS continuous playback of gestures one-by-one with non-blocking exit/interrupt safety.
